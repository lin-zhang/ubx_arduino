...
ubx.load_module(ni, "arduino_blocks/uno_test/uno_test.so")
...
print("creating instance of 'uno_test/uno_test'")
uno_test1=ubx.block_create(ni, "uno_test/uno_test", "uno_test1", {min_max_config={min=32, max=127}})
...
logger_conf=[[
{
   { blockname='uno_test1', portname="rnd", buff_len=1, },
...
ptrig1=ubx.block_create(ni, "std_triggers/ptrig", "ptrig1",
			{
			   ...
			   trig_blocks={ { b=uno_test1, num_steps=1, measure=0 },
...
print("running uno_test1 init", ubx.block_init(uno_test1))
