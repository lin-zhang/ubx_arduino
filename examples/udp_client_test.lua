...
ubx.load_module(ni, "arduino_blocks/udp_client/udp_client.so")
...
udp_client1=ubx.block_create(ni, "udp_client/udp_client", "udp_client1", {udp_client_config={host_ip='10.33.173.64', port=51068}})
...
print("running udp_client1 init", ubx.block_init(udp_client1))
