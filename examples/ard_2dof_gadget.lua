...
ubx.load_module(ni, "arduino_blocks/arduino_2dofGadget/arduino_2dofGadget.so")
...
print("creating instance of 'arduino_2dofGadget/arduino_2dofGadget'")
arduino_2dofGadget1=ubx.block_create(ni, "arduino_2dofGadget/arduino_2dofGadget", "arduino_2dofGadget1", {arduino_2dofGadget_config={portName='/dev/ttyACM0', brate=9600}})
...
ptrig1=ubx.block_create(ni, "std_triggers/ptrig", "ptrig1",
			{
			   ...
			   trig_blocks={ { b=arduino_upload1, num_steps=1, measure=0 },
					 { b=arduino_2dofGadget1, num_steps=1, measure=0 },	
...
print("running arduino_2dofGadget1 init", ubx.block_init(arduino_2dofGadget1))
...
ubx.block_start(arduino_2dofGadget1)
